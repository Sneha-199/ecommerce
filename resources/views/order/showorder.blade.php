...
<div class="content-wrapper">
  ...
  <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    ...
    <div class="d-flex align-items-center flex-wrap mr-2">
      <!--begin::Page Title-->
      <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">view order</h5>
      <!--end::Page Title-->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="display:flex">
                                    <a title="Edit" href="{{route('editOrder',[$order->id])}}" class="btn btn-primary">Edit</a>&nbsp;
                                    <a class="btn btn-danger" onclick="event.preventDefault();document.getElementById('delete-form{{ $order->id }}').submit();">
